...
export class LoginComponent implements OnInit {
  ...
  private crearFormularioReactivo(): void {
    this.form = this.fb.group ({
      nombre: ['admin', [Validators.required, Validators.minLength(2), Validators.maxLength(25)]],
      password: ['12345678', [Validators.required, Validators.minLength(5), Validators.maxLength(25)]]
    });
  }
